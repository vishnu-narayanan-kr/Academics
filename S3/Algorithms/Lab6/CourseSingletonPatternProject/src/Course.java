...
public class Course {
    ...
    /*
    public static Course searchCourses(LinkedListNode wcourse, String wcourse_code) {
        LinkedListNode current = wcourse;
        
        while(current != null) {
            if(current.info.getCourse_no().equals(wcourse_code)) {
                return current.info;
            }
