...
public class Faculty {
    ...
    public String toString() {
        ...
        display += "bonus_rate: " + f_Bonus + "%, ";
        display += "bonus: " + calculate_Bonus() + "$, ";
    ...
    public double calculate_Bonus() {
        return Math.round(f_Salary * f_Bonus) / 100.0;
    }
    ...
    public double doBonus_tax() {
        ...
        return Math.round((f_tax + p_tax) * calculate_Bonus() * 100) / 100.0;
    }
