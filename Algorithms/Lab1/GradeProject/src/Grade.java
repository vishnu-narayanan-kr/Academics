...
public class Grade {
    ...
    Grade(int student_id, String student_lname, String student_fname, int s_grade_assignment1, int s_grade_assignment2, int s_grade_assignment3, int s_grade_midTerm, int s_grade_finalTerm) {
    ...
    public String toString() {
        return "S Id: " + this.student_id + ", S Lname: " + this.student_lname + ", S Fname: " + this.student_fname
                ...
                + ", S MT: " + this.s_grade_midTerm + ", S FT: " + this.s_grade_finalTerm;
    }
