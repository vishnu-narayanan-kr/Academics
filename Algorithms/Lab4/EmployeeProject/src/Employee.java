...
public class Employee {
    ...
    private int emp_bonus;
    
    @Override
    public String toString() {
        return "[Employee: id " + this.emp_id + ", fname: " + this.emp_fname + ", lname: " + this.emp_lname + ", salary: " + this.emp_salary + ", d_id: " + this.emp_d_id + ", position: " + this.emp_position + ", " + this.emp_bonus + "]";
    }
